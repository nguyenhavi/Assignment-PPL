...
class MT22Parser ( Parser ):
    ...
    class Declare_var_no_assignContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitDeclare_var_no_assign" ):
                return visitor.visitDeclare_var_no_assign(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Arr_declareContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArr_declare" ):
                return visitor.visitArr_declare(self)
            else:
                return visitor.visitChildren(self)
    ...
    class List_para_declareContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitList_para_declare" ):
                return visitor.visitList_para_declare(self)
            else:
                return visitor.visitChildren(self)
